...
<footer className="p-4 bg-white sm:p-6 dark:bg-gray-900">
    ...
    <div className="sm:flex sm:items-center sm:justify-between">
        <span className="text-sm text-gray-500 sm:text-center dark:text-gray-400">© 2023 <a href="https://shanbhitech.com/" className="hover:underline">ShanbhiTechnology™</a>. All Rights Reserved.
        </span>
